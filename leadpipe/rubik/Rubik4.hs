...
showEdgeMove (M i t) = let (a, b) = i `divMod` 2
                       in showHex a . showsPrec 0 b . showIntTransform t
showFaceMove (M i t) = let (a, b) = i `divMod` 4
                       in showsPrec 0 a . showsPrec 0 b

data Rubik4Permutation = R { v :: Permutation SimplePermutation,
                             e :: SimplePermutation,
                             f :: SimplePermutation }
                         deriving (Eq, Ord)

instance Show Rubik4Permutation where
    showsPrec _ (R v e f) = showCycles showVectorMove v .
                            showString " | " .
                            showCycles showEdgeMove e .
                            showString " | " .
                            showCycles showFaceMove f

instance Transform Rubik4Permutation where
    identity = R identity identity
    (R v e f) *> (R v' e' f') = R (v*>v') (e*>e') (f*>f')
...
-- The Rubik4 permutation of a face rotated clockwise 90 degrees.
...
movePerms :: Array (Int, Int) Rubik4Permutation
...
-- Evaluates a string of moves, returns the rubik4 permutation resulting.
